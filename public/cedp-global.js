...
try {
  ...
  if (!isHomeF && !isMobileHelp) {
    var FOOTER =
      ...
      '</div>' +
      '</div>' +
      '<div class="ft-bottom" style="display:flex;justify-content:flex-end;align-items:center;gap:20px;margin-top:20px;">' +
      '<div class="ft-actions" style="display:flex;gap:10px;">' +
      ...
      '<img src="https://i0.wp.com/cedproject.org/wp-content/uploads/2022/10/cropped-CEDP_2022Logo_HouseIcons_RGBWeb-01.png?fit=270%2C270&quality=100&ssl=1" alt="CEDP" style="width:50px;height:auto;"/>' +
      '<div class="brand-mark-text">Community<br/>Economic<br/>Defense Project</div>' +
      '</div>' +
      '</div>' +
