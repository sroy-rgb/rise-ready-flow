  ...
  return (
    <>
      <style>{`
        ...
        .access-card{display:flex;flex-direction:column;align-items:center;gap:10px;width:260px;padding:18px 24px;border-radius:14px;border:1.5px solid #E8B960;background:rgba(27,40,56,.78);color:#fff;font-weight:700;font-size:16px;text-decoration:none;text-align:center;transition:transform .25s ease, box-shadow .25s ease, background .25s ease}
        ...
        @media (max-width:640px){
          ...
          .access-card{width:100%;max-width:320px;padding:13px 20px;font-size:15px}
        }
        @media (min-width:641px) and (max-width:1024px){
          .access-overlay{flex-wrap:wrap;gap:18px;padding:20px}
          .access-card{width:240px;padding:16px 20px;font-size:15px}
        }
      `}</style>
